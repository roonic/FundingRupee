      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid md:grid-cols-3 gap-10">
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="mt-6 space-y-3">
            ...
            <p className="text-sm text-gray-600">
              Have a question or need assistance? <button className="text-blue-500 hover:underline">Contact Us</button>
            </p>
          </div>
        </div>
              ...
              recentDonations.map((donation) => (
                ...
                >
                  <div className="flex justify-between font-semibold">
                    <span>{donation.anonymous ? "Anonymous" : donation.donor?.name || "Anonymous"}</span>
